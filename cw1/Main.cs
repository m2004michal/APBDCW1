...
public class MainClass {
    ...
    {
        FluidContainer? fluidContainer = new FluidContainer(2,300, 12, 4000);
        fluidContainer.Load(3000, false);
        Console.WriteLine("cargo weight = " + fluidContainer.CargoWeight);
        // fluidContainer.Offload();
        // Console.WriteLine("cargo weight = " + fluidContainer.CargoWeight);
        
        GasContainer? gasContainer = new GasContainer(2,300, 12, 4000);
        ...
        CooledContainer? cooledContainer = new CooledContainer(2, 300, 12, 4000, "Banana",10);
        ...
        GasContainer? gasContainer2 = new GasContainer(2,300, 12, 4000);
        ...
        GasContainer? gasContainer3 = new GasContainer(2,300, 12, 4000);
        ...
        GasContainer? gasContainer4 = new GasContainer(2,300, 12, 4000);
        ...
        GasContainer? gasContainer5 = new GasContainer(2,300, 12, 4000);
